<div class="container mt-2" align="center">
    <h2 class="mb-4">Selamat Datang <?= $this->session->userdata('nama')?></h2>
</div>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        .container-transparent {
            /* background-color: rgba(255, 255, 255, 0.5); Background kontainer transparan */
            border-radius: 10px; /* Sudut bulat pada kontainer */
            padding: 20px; /* Jarak padding di dalam kontainer */
        }
        .carousel-item img {
            height: 500px; /* Menyesuaikan tinggi gambar */
            object-fit: cover; /* Membuat gambar memenuhi kotak tanpa mengubah aspek rasio */
        }
        .carousel-caption {
            /* background-color: rgba(0, 0, 0, 0.7); Latar belakang semi-transparan pada keterangan */
            border-radius: 10px; /* Sudut bulat pada keterangan */
            padding: 10px; /* Jarak padding di dalam keterangan */
        }
    </style>
</head>
<body>
